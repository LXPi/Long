...
<%@ page import="com.longimage.TaocansEntity" %>
...
<script type="text/javascript" src="../../base/js/blockui.js"></script>
	...
	<% SessionFactory sessionFactory =HibernautUtil.getSessionFactory(5);
		...
		Query q1 = sessions.createQuery("from TaocansEntity ");
		List<TaocansEntity> list1=q1.list();
		t.commit();
...
<link href="../../page/templates/css/phototwoclass.css" rel="stylesheet" type="text/css">
<div class="phototwoclass">

<div class="phototwoclass_top"><a href="Index2.jsp" target="_self">殡葬服务</a> (<%=list1.size()%>)</div>
</div>
...
<link href="../../page/templates/css/photoquery.css" rel="stylesheet" type="text/css">
<div id="photoquery">
	<div id="showcanpin">
